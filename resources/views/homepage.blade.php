            ...
            <?php for ($i=1; $i <= 6; $i++) { ?>
                <div class="slide-content">
                    <div class="template-content">
                        ...
                        <div class="template-img"  onclick="mark(this)" data-tn="{{ route('download_template_excel', ['template' => $i]) }}">
        ...
        <div class="container">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-4 column">
                    <form method="POST" action="{{route('post_excel')}}" enctype="multipart/form-data" id="templateForm">
                        @csrf
                        Upload file template<input type="file" name="file_excel">
                        Download file template <a href="{{ route('download_template_excel', 'template_1') }}" class="btn">Download Template</a>
                        <button>Gửi</button>
                    </form>
                </div>
                 <div class="col-md-4 column"></div>
